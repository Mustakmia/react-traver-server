...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.dpihr.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
const run = async () => {
    try {
        ...
        const touristCollection = database.collection("sights");
